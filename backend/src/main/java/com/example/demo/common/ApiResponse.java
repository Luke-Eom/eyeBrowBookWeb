...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> invalidAccessToken() {
        return new ApiResponse<T>(new ApiResponseHeader(FAILED, INVALID_ACCESS_TOKEN), null);
    }

    public static <T> ApiResponse<T> invalidRefreshToken() {
        return new ApiResponse<T>(new ApiResponseHeader(FAILED, INVALID_REFRESH_TOKEN), null);
    }

    public static <T> ApiResponse<T> notExpiredTokenYet() {
        return new ApiResponse<T>(new ApiResponseHeader(FAILED, NOT_EXPIRED_TOKEN_YET), null);
    }
